  ...
  return (
    <section className="relative min-h-screen gradient-mesh">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4 animate-fade-in-up">Careers</h1>
        <p className="text-lg text-muted-foreground max-w-2xl animate-fade-in-up">
          We’re not hiring yet, but stay tuned for roles across product, engineering, and growth.
        </p>
      </div>
    </section>
  );
